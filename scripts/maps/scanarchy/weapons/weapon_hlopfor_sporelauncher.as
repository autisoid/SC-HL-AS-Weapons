...
class ofspore : ScriptBaseEntity
{
  ...
  void Spawn()
  {
    ...
    pev.gravity = 1.0f;
    @m_pDamage = g_EngineFuncs.CVarGetPointer("sk_plr_spore");
    pev.dmg = m_pDamage.value;
  ...
  void BounceTouch(CBaseEntity@ pOther)
  {
    ...
    {
      pOther.TakeDamage(pev, pev.owner.vars, m_pDamage.value, DMG_GENERIC);
      Detonate();
    }
  }
...
class weapon_ofsporelauncher : ScriptBasePlayerWeaponEntity
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model("models/scanarchy/w_spore_launcher.mdl"));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel("models/scanarchy/w_spore_launcher.mdl");
    g_Game.PrecacheModel("models/scanarchy/v_spore_launcher.mdl");
    g_Game.PrecacheModel("models/scanarchy/p_spore_launcher.mdl");
  ...
  bool Deploy()
  {
    self.DefaultDeploy(self.GetV_Model("models/scanarchy/v_spore_launcher.mdl"), self.GetP_Model("models/scanarchy/p_spore_launcher.mdl"), DRAW1, "rpg");
  ...
  {
    SporeLauncherFire(1000.0f, false);
  }
...
string GetName()
{
  return "weapon_hlopfor_sporelauncher";
}
...
void Register()
{
  if (!g_CustomEntityFuncs.IsCustomEntity(GetName()))
  {
    ...
    g_ItemRegistry.RegisterWeapon(GetName(), "scanarchy", "sporeclip", "", "ammo_sporeclip", "");
  }
}
