...
string g_VeeMdl = "models/hlclassic/v_357.mdl";
string g_PeeMdl = "models/hlclassic/p_357.mdl";
string g_WeeMdl = "models/hlclassic/w_357.mdl";
...
class weapon_hl357 : ScriptBasePlayerWeaponEntity
{
	...
	void Spawn()
	{
        ...
        @m_pDamage = g_EngineFuncs.CVarGetPointer("sk_plr_357_bullet");
	}
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( g_VeeMdl ), self.GetP_Model( g_PeeMdl ), PYTHON_DRAW, "python" );
	}
	...
	void PrimaryAttack()
	{
		...
		m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_357, 0, int(m_pDamage.value) );
...
{
	return "weapon_hldm_357";
}

void Register()
{
    if (g_eModelsMode == kOpposingForce) {
        g_VeeMdl = "models/scanarchy/opfor/v_357.mdl";
    } else if (g_eModelsMode == kBlueShift) {
        g_VeeMdl = "models/scanarchy/bshift/v_357.mdl";
    }
    
	g_CustomEntityFuncs.RegisterCustomEntity( "HLPYTHON::weapon_hl357", GetHLPYTHONName() );
	g_ItemRegistry.RegisterWeapon( GetHLPYTHONName(), "scanarchy", "357", "", "ammo_357", "" );
}
}