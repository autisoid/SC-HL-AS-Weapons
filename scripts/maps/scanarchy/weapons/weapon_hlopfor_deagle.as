...
class weapon_ofeagle : ScriptBasePlayerWeaponEntity
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model("models/scanarchy/w_desert_eagle.mdl"));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel("models/scanarchy/w_desert_eagle.mdl");
    g_Game.PrecacheModel("models/scanarchy/v_desert_eagle.mdl");
    g_Game.PrecacheModel("models/scanarchy/p_desert_eagle.mdl");
    ...
    g_SoundSystem.PrecacheSound("scanarchy/weapons/desert_eagle_reload.wav"); // sequence: 7, 8; frame: 1; event 5004
    g_Game.PrecacheGeneric("sound/scanarchy/weapons/desert_eagle_reload.wav");
  ...
  bool Deploy()
  {
    ...
    self.DefaultDeploy(self.GetV_Model("models/scanarchy/v_desert_eagle.mdl"), self.GetP_Model("models/scanarchy/p_desert_eagle.mdl"), DRAW, "onehanded");
...
void Register()
{
  if (!g_CustomEntityFuncs.IsCustomEntity(GetName()))
  {
    ...
    g_ItemRegistry.RegisterWeapon(GetName(), "scanarchy", "357", "", "ammo_357", "");
  }
}
