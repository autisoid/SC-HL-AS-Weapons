...
class weapon_ofsniperrifle : ScriptBasePlayerWeaponEntity
{
  ...
  {
    Precache();
    g_EntityFuncs.SetModel(self, self.GetW_Model("models/scanarchy/w_m40a1.mdl"));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel("models/scanarchy/w_m40a1.mdl");
    g_Game.PrecacheModel("models/scanarchy/v_m40a1.mdl");
    g_Game.PrecacheModel("models/scanarchy/p_m40a1.mdl");
    ...
    g_SoundSystem.PrecacheSound("scanarchy/weapons/sniper_bolt1.wav"); // sequence: 2; frame: 32; event 5004
    g_Game.PrecacheGeneric("sound/scanarchy/weapons/sniper_bolt1.wav");
    g_SoundSystem.PrecacheSound("scanarchy/weapons/sniper_bolt2.wav"); // sequence: 3; frame: 32; event 5004
    g_Game.PrecacheGeneric("sound/scanarchy/weapons/sniper_bolt2.wav");
    g_SoundSystem.PrecacheSound("scanarchy/weapons/sniper_reload_first_seq.wav"); // sequence: 4, 6; frame: 1; event 5004
    g_Game.PrecacheGeneric("sound/scanarchy/weapons/sniper_reload_first_seq.wav");
    g_SoundSystem.PrecacheSound("scanarchy/weapons/sniper_reload_second_seq.wav"); // sequence: 5; frame: 1; event 5004
    g_Game.PrecacheGeneric("sound/scanarchy/weapons/sniper_reload_second_seq.wav");
  ...
  bool Deploy()
  {
    self.DefaultDeploy(self.GetV_Model("models/scanarchy/v_m40a1.mdl"), self.GetP_Model("models/scanarchy/p_m40a1.mdl"), DRAW, "sniper");
...
string GetName()
{
  return "weapon_hlopfor_sniperrifle";
}
...
void Register()
{
  if (!g_CustomEntityFuncs.IsCustomEntity(GetName()))
  {
    ...
    g_ItemRegistry.RegisterWeapon(GetName(), "scanarchy", "m40a1", "", "ammo_762", "");
  }
}
