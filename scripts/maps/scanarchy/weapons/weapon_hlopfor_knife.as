...
class weapon_ofknife : ScriptBasePlayerWeaponEntity
{
  ...
  void Spawn()
  {
    ...
    g_EntityFuncs.SetModel(self, self.GetW_Model("models/scanarchy/w_knife.mdl"));
  ...
  void Precache()
  {
    ...
    g_Game.PrecacheModel("models/scanarchy/w_knife.mdl");
    g_Game.PrecacheModel("models/scanarchy/v_knife.mdl");
    g_Game.PrecacheModel("models/scanarchy/p_knife.mdl");
    ...
    g_Game.PrecacheGeneric("sprites/scanarchy/640hudof03.spr");
    g_Game.PrecacheGeneric("sprites/scanarchy/640hudof04.spr");
  ...
  bool Deploy()
  {
    self.DefaultDeploy(self.GetV_Model("models/scanarchy/v_knife.mdl"), self.GetP_Model("models/scanarchy/p_knife.mdl"), DRAW, "crowbar");
...
void Register()
{
  if (!g_CustomEntityFuncs.IsCustomEntity(GetName()))
  {
    ...
    g_ItemRegistry.RegisterWeapon(GetName(), "scanarchy", "", "", "", "");
  }
}
