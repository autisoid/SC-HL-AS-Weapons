...
const uint DAMAGE_PER_HIT = 10;

class CPlayerHornet : ScriptBaseMonsterEntity
{
	...
	void Spawn()
	{
		...
		m_flStopAttack = g_Engine.time + (3.5f); // 5.0 for SP
...
void RegisterHornetProjectile()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "SCAHORNETPROJECTILE::CPlayerHornet", "sca_playerhornet" );
}
