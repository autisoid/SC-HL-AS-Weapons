...
#include "xWhitey/weapons/weapons"
#include "xWhitey/weapons/weapon_hlopfor_displacer"

array<ItemMapping@> g_ItemMappings = { ItemMapping( "weapon_m16", "weapon_9mmAR" ), ItemMapping("weapon_gauss", "weapon_hldm_gauss"), ItemMapping("weapon_egon", "weapon_hlc_hldm_egon"), ItemMapping("weapon_hornetgun", "weapon_hlc_hldm_hornetgun"), ItemMapping("weapon_displacer", "weapon_hlc_displacer") };
